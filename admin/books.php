						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								while ($row = $books->fetch_assoc()) :
									// Calculate the number of days between pickup date and dropoff date
									$pickupDate = new DateTime($row['pickup_datetime']);
									$dropoffDate = new DateTime($row['dropoff_datetime']);
									$diff = $pickupDate->diff($dropoffDate);
									$days = $diff->days;
								?>
									<tr>
